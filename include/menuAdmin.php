<div class="menu-area">
	<div id="dl-menu" class="dl-menuwrapper">
		...
		<ul class="dl-menu">
			<li><a href="?perfil=admin&p=visaogeral">Administrador Geral</a>
				<ul class="dl-submenu">
					...
					<li><a href="?perfil=admin&p=scripts"> Scripts</a>
						<ul class="dl-submenu">
							...
							<li><a href="<?=$relatorioProponentes?>">Relatório Proponentes por Espaços Abertos</a></li>
			...
			<li><a href="?perfil=admin&p=visaogeral">Administrador Local</a>
				<ul class="dl-submenu">
					<li><a href="?perfil=admin&p=users"> Listar Usuários</a></li>
