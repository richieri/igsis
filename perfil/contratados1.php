	...
	<section id="services" class="home-section bg-white">
		<div class="container">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
						<form method="POST" action="?perfil=contratados&p=fisica&pag=pesquisar" class="form-horizontal" role="form">
...
// Endereço da página
$link = "?perfil=contratados&p=fisica&pag=pesquisar";
