		...
		<div class="row">
			<div class="col-md-offset-1 col-md-10">
				<div class="section-heading">
					<h2>Comunicação</h2>
					<div class="col-md-offset-2 col-md-6"><a href='?perfil=comunicacao&p=editados' class='btn btn-theme btn-lg btn-block'>Eventos Editados</a>
					</div>
					<div class="col-md-6"><a href='?perfil=comunicacao&p=editados_nao' class='btn btn-theme btn-lg btn-block'>Eventos Não Editados</a>
					</div>									
                </div>
				<p>&nbsp;</p>
