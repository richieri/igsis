...
$sql_lista = "
	SELECT eve.idEvento, eve.nomeEvento, eve.nomeGrupo, loc.sala, age.data, age.hora, tip.tipoEvento, eve.sinopse
	...
	INNER JOIN ig_tipo_evento AS tip ON tip.idTipoEvento = age.idTipo
	WHERE eve.publicado=1 AND eve.dataEnvio IS NOT NULL AND eve.projetoEspecial IN (54) AND age.data BETWEEN '2018-05-19' AND '2018-05-20'
	ORDER BY eve.nomeEvento, age.data, age.hora";
...
<section id="list_items" class="home-section bg-white">
	<div class="container">
		<div class="sub-title"><h4>EVENTOS VIRADA CULTURAL 2018</h4>
		</div>
		...
		<div class="table-responsive list_info">
			...
			<?php
				while($campo = mysqli_fetch_array($query_lista))
				{
					...
					echo "<td class='list_description'>".$campo['tipoEvento']."</td>";
					echo "<td class='list_description'>".$campo['sinopse']."</td>";
					echo "</tr>";
				}
			?>
					<tr>
