			...
			<div class="form-group">
				<div class="col-md-offset-2 col-md-8">
					<h5><?php if(isset($mensagem)){ echo $mensagem; } ?></h5>
						<form method="POST" action="?perfil=contabilidade&p=frm_busca_formacao" class="form-horizontal" role="form">
...
<br /><br />
	<section id="list_items">
		<div class="container">
             ...
             <h5><a href="?perfil=contabilidade&p=frm_busca_formacao">Fazer outra busca</a></h5>
