				...
				<div class="row">
					<div class="form-group">
						<div class="col-md-offset-2 col-md-8">
							...
							<form method="POST" action="?perfil=curadoria&p=frm_busca" class="form-horizontal" role="form">
...
<?php
	...
	{
		$con = bancoMysqli();
		$sql_existe = "SELECT DISTINCT idEvento FROM ig_ocorrencia WHERE publicado = 1 ORDER BY dataInicio DESC";
...
?>
	...
	<section id="list_items">
		<div class="container">
			...
			?>
			<h5><a href="?perfil=curadoria&p=frm_busca">Fazer outra busca</a></h5>
