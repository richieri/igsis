                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading">
                            <h2>Contratados</h2>
                            <p>Você está inserindo pessoas físicas ou jurídicas para serem contratadas para o evento
                                <strong><?php echo $nomeEvento['nomeEvento']; ?></strong></p>
				...
				AND publicado = '1'";
                    ...
                    if ($num_reg > 0) {
						...
						<input type ='submit' class='btn btn-theme btn-sm btn-block' value='editar pedido'";
                                if ($descricao['tipoPessoa'] == 3) {
                                    echo "disabled";
                                } //não permite que Representante legal faça pedido.
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-8">
                                <a href="?perfil=contratados&p=fisica" class="btn btn-theme btn-lg btn-block">Inserir um
                                    pedido Pessoa Física</a>
                                <a href="?perfil=contratados&p=juridica" class="btn btn-theme btn-lg btn-block">Inserir
                                    um pedido Pessoa Jurídica</a>
                            </div>
                        </div>
                        <?php
                    }
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading">
                            ...
                            <p>Você está inserindo pessoas jurídicas para serem contratadas para o evento
                                <strong><?php echo $nomeEvento['nomeEvento']; ?></strong></p>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading">
                            ...
                            <p>Você está inserindo pessoas físicas para serem contratadas para o evento
                                <strong><?php echo $nomeEvento['nomeEvento']; ?></strong></p>
                            <p></p>
                        </div>
                    </div>
                ...
                if ($_POST['idPessoa'] == 0) {
                    ...
                    <section id="services" class="home-section bg-white">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-offset-2 col-md-8">
                                    <div class="section-heading">
                                        ...
                                        <p>A pessoa jurídica para quem você está cadastrando representantes legais é
                                            <strong><?php echo $pessoa['nome']; ?></strong></p>
                                        <p><?php if (isset($mensagem)) {
                                                echo $mensagem;
                                            } ?></p>
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8">
                                        <form method="POST" action="?perfil=contratados&p=representante&action=busca"
                    ...
                    <section id="contact" class="home-section bg-white">
                        <div class="container">
                            <div class="form-group">
                                <h2>CADASTRO DE REPRESENTANTE LEGAL</h2>
                                <p>A pessoa jurídica para quem você está cadastrando representante legal é
                                    <strong><?php echo $empresa['Nome']; ?></strong></p>
                            </div>
                            <div class="row">
                                <div class="col-md-offset-1 col-md-10">
                                    <form class="form-horizontal" role="form"
                                          action="?perfil=contratados&p=representante&action=edita" method="post">
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-8">
                                                <input type="text" class="form-control" id="RepresentanteLegal"
                                                       name="RepresentanteLegal" value="<?php echo $pessoa['Nome'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6">
                                                <input type="text" class="form-control" id="RG" name="RG"
                                                       placeholder="RG" value="<?php echo $pessoa['RG'] ?>">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" readonly class="form-control" id="cpf" name="CPF"
                                                       placeholder="CPF" value="<?php echo $pessoa['CPF'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-8">
                                                <input type="text" class="form-control" id="Nacionalidade"
                                                       ...
                                                       value="<?php echo $pessoa['Nacionalidade'] ?>">
                                            </div>
                                        </div>
                                        <!-- Botão Gravar -->
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6">
                                            <form class="form-horizontal" role="form"
                                                  action="?perfil=contratados&p=edicaoPessoa" method="post">
                                                <input type="hidden" name="numero"
                                                       value="<?php echo $_SESSION['numero'] ?>"/>
                                        ...
                                        <div class="col-md-6">
                                            <form class="form-horizontal" role="form"
                                                  action="?perfil=contratados&p=representante&action=edita"
                                                  method="post">
                                                <input type="hidden" name="idPessoa" value="0"/>
                                                <input type="submit" name="enviar" value="Inserir outro representante"
                                                       class="btn btn-theme btn-block">
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-8">
                                        <div class="section-heading">
                                            <h2>CADASTRO DE REPRESENTANTE LEGAL</h2>
                                            <p>O sistema encontrou informações sobre representantes legais com
                                                referência a <br/><strong><?php echo $_POST['busca'] ?>. </strong><br/>
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
=======
                        ...
                        <section id="contact" class="home-section bg-white">
                            <div class="container">
                                <div class="form-group">
                                    <h3>CADASTRO DE REPRESENTANTE LEGAL</h3>
                                    <p>Não foi encontrado nenhum registro com o seguinte
                                        CPF <?php echo $_POST['busca']; ?></p>
                                </div>
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-10">
                                        <form class="form-horizontal" role="form"
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-8">
                                                    <input type="text" class="form-control" id="RepresentanteLegal"
                                                           name="RepresentanteLegal" placeholder="Representante Legal">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-6">
            ...
            if ($verificaCNPJ['numero'] > 0) {
                ...
                if ($query_inserir_pj) {
                    ...
                    if ($query_ultimo) {
                        ...
                        $id_ped = $_GET['id_ped'];
                        $sql_atualiza_cnpj = "UPDATE `igsis_pedido_contratacao` 
>>>>>>> parent of 59e25f1... Revert "algumas alteraçoes"
								SET `idPessoa` = '$idJuridica'
								WHERE `idPedidoContratacao` = '$id_ped'";
                        $query_atualiza_cnpj = mysqli_query($con, $sql_atualiza_cnpj);
                        if ($query_atualiza_cnpj) {
...
>>>>>>> parent of 59e25f1... Revert "algumas alteraçoes"
                <div class="form-group">
                    <h2>PEDIDO DE CONTRATAÇÃO <?php if ($pedido['tipoPessoa'] == 1) {
                            echo "PESSOA FÍSICA";
                        } else {
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-8">
                                <p class="left">
                                    ...
                                    <strong>Categoria de
                                        contratação:</strong> <?php recuperaModalidade($evento['ig_modalidade_IdModalidade']); ?>
                                    <br/>
                                    <?php
                                    ...
                                    ?>
                                    <strong>Objeto:</strong> <?php echo retornaTipo($evento['ig_tipo_evento_idTipoEvento']) ?>
                                    - <?php echo $evento['nomeEvento']; ?> <br/>
                                    ...
                                    ?>
                                    <strong>Fiscal:</strong> <?php echo $fiscal['nomeCompleto']; ?> -
                                    <strong>Suplente:</strong> <?php echo $suplente['nomeCompleto']; ?>
                                </p>
                            </div>
                        </div>
                        <?php
                        if ($pedido['tipoPessoa'] == 2) {
                            ...
                            <form class="form-horizontal" role="form"
                                  action="?perfil=contratados&p=edicaoProponente&id_ped=<?php echo $pedido['idPedidoContratacao'] ?>"
                                  method="post">
                                <div class="col-md-offset-2 col-md-8"><strong>Proponente:</strong><br/>
                                    <input type='text' readonly class='form-control' name='proponente' id='proponente'
                                           value="<?php echo $juridica['RazaoSocial']; ?>">
                                    <input type="submit" class="btn btn-theme btn-med btn-block"
                                           value="Mudar Proponente">
                                </div>
                            </form>
                            <form class="form-horizontal" role="form"
                                  action="?perfil=contratados&p=edicaoExecutante&id_pf=" method="post">
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8"><strong>Líder do Grupo:</strong><br/>
                                        <input type='text' readonly class='form-control' name='Executante'
                                               id='Executante' value="<?php echo $executante['Nome']; ?>">
                                    </div>
                                    <div class="col-md-offset-2 col-md-8">
                                        <input type="hidden" name="idPedido"
                                               value="<?php echo $_SESSION['idPedido']; ?>"/>
                                        <?php
                                        if ($pedido['IdExecutante'] == NULL OR $pedido['IdExecutante'] == "") {
                                            ?>
                                            <input type="submit" class="btn btn-theme btn-med btn-block"
                                                   value="Inserir Líder do Grupo">
                                            <?php
                                        } else {
                                            ?>
                                            <input type="submit" class="btn btn-theme btn-med btn-block"
                                                   value="Mudar Líder do Grupo">
                                            <?php
                                        }
                                        ?>
                                    </div>
                        ...
                        <!-- /Grupo -->
                        <form class="form-horizontal" role="form" onsubmit="return valida()"
                              action="?perfil=contratados&p=edicaoPedido" method="post">
                            <?php
                            $multiplo = recuperaDados("sis_verba", $pedido['idVerba'], "Id_Verba");
                            if ($pedido['parcelas'] > 1 OR $multiplo['multiplo'] == '1')
                            {
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-8"><strong>Valor:</strong><br/>
                                    <input type='text' disabled name="valor_parcela" id='valor' class='form-control'
                                           value="<?php echo dinheiroParaBr($pedido['valor']) ?>">
                                </div>
                                <?php
                                }
                                else
                                ...
                                if ($pedido['parcelas'] > 0) {
                                    ?>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8"><strong>Forma de Pagamento / Valor da
                                                Prestação de Serviço:</strong><br/>
                                            <textarea disabled name="formaPagamento" class="form-control" cols="40"
                                                      rows="5"><?php echo txtParcelas($_SESSION['idPedido'], $pedido['parcelas']); ?>
								</textarea>
                                            <p></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8"><strong>Forma de Pagamento / Valor da
                                                Prestação de Serviço:</strong><br/>
                                            <textarea name="formaPagamento" class="form-control" cols="40"
                                                      rows="5"><?php echo $pedido['formaPagamento'] ?></textarea>
                                        </div>
                                    </div>
                                    <?php
                                }
                                ?>
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8"><strong>Parcelas (antes de editar as parcelas,
                                            é preciso salvar o pedido)</strong><br/>
                                        <select class="form-control" id="parcelas" name="parcelas">
                                            <option value="0" <?php if ($pedido['parcelas'] == '0') {
                                                echo "selected";
                                            } ?> >Outros
                                            </option>
                                            <option value="1" <?php if ($pedido['parcelas'] == '1') {
                                                echo "selected";
                                            } ?> >Parcela única
                                            </option>
                                            <option value="2" <?php if ($pedido['parcelas'] == '2') {
                                                echo "selected";
                                            } ?> >2 parcelas
                                            </option>
                                            <option value="3" <?php if ($pedido['parcelas'] == '3') {
                                                echo "selected";
                                            } ?> >3 parcelas
                                            </option>
                                            <option value="4" <?php if ($pedido['parcelas'] == '4') {
                                                echo "selected";
                                            } ?> >4 parcelas
                                            </option>
                                            <option value="5" <?php if ($pedido['parcelas'] == '5') {
                                                echo "selected";
                                            } ?> >5 parcelas
                                            </option>
                                            <option value="6" <?php if ($pedido['parcelas'] == '6') {
                                                echo "selected";
                                            } ?> >6 parcelas
                                            </option>
                                            <option value="7" <?php if ($pedido['parcelas'] == '7') {
                                                echo "selected";
                                            } ?> >7 parcelas
                                            </option>
                                            <option value="8" <?php if ($pedido['parcelas'] == '8') {
                                                echo "selected";
                                            } ?> >8 parcelas
                                            </option>
                                            <option value="9" <?php if ($pedido['parcelas'] == '9') {
                                                echo "selected";
                                            } ?> >9 parcelas
                                            </option>
                                            <option value="10" <?php if ($pedido['parcelas'] == '10') {
                                                echo "selected";
                                            } ?> >10 parcelas
                                            </option>
                                            <option value="11" <?php if ($pedido['parcelas'] == '11') {
                                                echo "selected";
                                            } ?> >11 parcelas
                                            </option>
                                            <option value="12" <?php if ($pedido['parcelas'] == '12') {
                                                echo "selected";
                                            } ?> >12 parcelas
                                            </option>
                                        </select>
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8">
                                            <a href="?perfil=contratados&p=edicaoParcelas"
                                               class="btn btn-theme btn-block">Editar parcelas</a>
                                        </div>
                                    </div>
                                    <?php
                                }
                                ...
                                if ($verbas['multiplo'] == 1) {
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8">
                                            <a href="?perfil=contratados&p=edicaoVerbas"
                                               class="btn btn-theme btn-block">Editar verbas múltiplas</a>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8"><strong>Integrantes do grupo:</strong><br/>
                                        <label>Esse campo deve conter a listagem de pessoas envolvidas no espetáculo
                                            <font color='#FF0000'>incluindo o líder do grupo</font>.<br/>Apenas o <font
                                                    color='#FF0000'>nome civil, RG e CPF</font> de quem irá se
                                            apresentar, excluindo técnicos.</i></strong></label>
                                        <p align="justify"><font color="gray"><strong><i>Elenco de
                                                        exemplo:</strong><br/>Ana Cañas RG 00000000-0 CPF 000.000.000-00<br/>Lúcio
                                                Maia RG 00000000-0 CPF 000.000.000-00<br/>Fabá Jimenez RG 00000000-0 CPF
                                                000.000.000-00</br>Fabio Sá RG 00000000-0 CPF 000.000.000-00</br>Marco
                                                da Costa RG 00000000-0 CPF 000.000.000-00</font></i></p>
                                        <textarea name="integrantes" class='form-control' cols="40"
                                                  rows="5"><?php echo $pedido['integrantes'] ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8">
                                        <label>Justificativa*</label>
                                        <textarea name="justificativa" required class="form-control" rows="10"
                                                  placeholder="Texto usado fins jurídicos e confecção de contratos."><?php echo $pedido["justificativa"] ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8">
                                        <label>Parecer artístico</label>
                                        <textarea name="parecerArtistico" readonly class="form-control" rows="10"
                                                  placeholder="Texto usado fins jurídicos e confecção de contratos."><?php $pedido_parecer_artistico = str_replace('<br />', "\n\n", $pedido["parecerArtistico"]);
                                            echo $pedido_parecer_artistico; ?></textarea>
                                    </div>

                                    <div class='col-md-offset-2 col-md-6'>
                                        <a href='?perfil=contratados&p=edicaoParecer&artista=Local'
                                           class='btn btn-theme btn-block'>Editar parecer artista local</a>
                                    </div>
                                    <div class='col-md-6'>
                                        <a href='?perfil=contratados&p=edicaoParecer&artista=Consagrado'
                                           class='btn btn-theme btn-block'>Editar parecer artista consagrado</a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8"><strong>Observação:</strong><br/>
                                        <textarea name="Observacao" class='form-control' cols="40"
                                                  rows="5"><?php echo $pedido['observacao'] ?></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-6"><strong>Quantidade de
                                            Apresentações:</strong><br/>
                                        <input type='text' name="qtdApresentacoes" id='qtdApresentacoes'
                                               class='form-control' value="<?php echo $pedido['qtdApresentacoes'] ?>">
                                    </div>
                                    <div class="col-md-6"><strong>Data do Kit de Pagamento:</strong><br/>
                                        <input type='text' name="dataKitPagamento" id="datepicker01"
                                               class='form-control'
                                               value="<?php echo exibirDataBr($pedido['dataKitPagamento']) ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8">
                                        <input type="hidden" name="atualizar"
                                               value="<?php echo $pedido['parcelas']; ?>"/>
                                        <input type="hidden" name="idPedidoContratacao"
                                               value="<?php echo $_SESSION['idPedido']; ?>"/>
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-6">
                                <form method='POST' action='?perfil=contratados&p=arqped'>
                                    <input type="hidden" name="idPedido" value="<?php echo $_SESSION['idPedido']; ?>">
                                    <input type="submit" name="" value="ANEXAR ARQUIVOS"
                                           class="btn btn-theme btn-lg btn-block">
                                </form>
                            </div>
                            <div class="col-md-6">
                                <a href="?perfil=contratados" value="VOLTAR" class="btn btn-theme btn-lg btn-block">VOLTAR
                                    para contratados</a>
                            </div>
                        </div>
                    </div>
...
=======
                    ...
                    <section id="contact" class="home-section bg-white">
                        <div class="container">
                            <div class="form-group">
                                <h3>CADASTRO DE PESSOA JURÍDICA</h3>
                                <p>Não foram encontradas nenhuma pessoa jurídica com referência
                                    <strong><?php echo $_POST['busca'] ?></strong></p>
                            </div>
                            <div class="row">
                                <div class="col-md-offset-1 col-md-10">
                                    <?php
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6"><strong>CNPJ:</strong><br/>
                                            <input type="text" readonly class="form-control" id="CNPJ" name="CNPJ"
                                                   placeholder="CNPJ" value=<?php echo $_POST['busca'] ?>>
                                        </div>
                                        <div class="col-md-6"><strong>CCM:</strong><br/>
                ...
                <section id="services" class="home-section bg-white">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-8">
                                <div class="section-heading">
                                    <h2>Líder do Grupo - Pessoa Física</h2>
                                    <p>Você está inserindo pessoas físicas para serem contratadas para o evento
                                        <strong><?php //echo $nomeEvento['nomeEvento'];
                                            ?></strong></p>
                                    <p></p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-8">
                                    <form method="POST" action="?perfil=contratados&p=edicaoExecutante&id_pf="
                                          class="form-horizontal" role="form">
                                        <label>Insira o CPF</label>
                                        <input type="text" name="busca" class="form-control" id="cpf">
                                        <br/>
                    ...
                    if ($num_busca > 0) {
                        ...
                        <section id="contact" class="home-section bg-white">
                            <div class="container">
                                <div class="form-group">
                                    <h3>CADASTRO DE PESSOA FÍSICA</h3>
                                    <p> O CPF <?php echo $busca; ?> não está cadastrado no nosso sistema. <br/>Por
                                        favor, insira as informações da Pessoa Física a ser contratada. </p>
                                    <p><a href="?perfil=contratados&p=edicaoExecutante&id_pf="> Pesquisar outro CPF</a>
                                    </p>
                                </div>
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-10">
                                        <form class="form-horizontal" role="form"
                                              action="?perfil=contratos&p=frm_edita_propostapj&id_ped=<?php echo $_SESSION['idPedido'] ?>"
                                              method="post">
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-8"><strong>Nome *:</strong><br/>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-8"><strong>Nome
                                                        Artístico:</strong><br/>
                                                    <input type="text" class="form-control" id="NomeArtistico"
                                                           name="NomeArtistico" placeholder="Nome Artístico">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-6"><strong>Tipo de documento
                                                        *:</strong><br/>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-6"><strong>CPF *:</strong><br/>
                                                    <input type="text" class="form-control" id="cpf" name="CPF" readonly
                                                           placeholder="CPF" value="<?php echo $busca; ?> ">
                                                </div>
                                                <div class=" col-md-6"><strong>CCM *:</strong><br/>
                                                    <input type="text" class="form-control" id="CCM" name="CCM"
                                                           placeholder="CCM">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-6"><strong>Data de
                                                        nascimento:</strong><br/>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-8"><strong>Complemento
                                                        *:</strong><br/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class=" col-md-6"><strong>Telefone #1 *:</strong><br/>
                                                    <input type="text" class="form-control" id="telefone"
                                                           ...
                                                           name="Telefone1" placeholder="Exemplo: (11) 98765-4321">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-6"><strong>Telefone #2:</strong><br/>
                                                    <input type="text" class="form-control" id="telefone"
                                                           onkeyup="mascara( this, mtel );" maxlength="15"
                                                           name="Telefone2" placeholder="Exemplo: (11) 98765-4321">
                                                </div>
                                                <div class="col-md-6"><strong>Telefone #3:</strong><br/>
                                                    <input type="text" class="form-control" id="telefone"
                                                           onkeyup="mascara( this, mtel );" maxlength="15"
                                                           name="Telefone3" placeholder="Exemplo: (11) 98765-4321">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-6"><strong>DRT:</strong><br/>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-6"><strong>Inscrição do INSS ou
                                                        PIS/PASEP:</strong><br/>
                                                    <input type="text" class="form-control" id="InscricaoINSS"
                                                           name="InscricaoINSS"
                                                           placeholder="Inscrição no INSS ou PIS/PASEP">
                                                </div>
                                                <div class=" col-md-6"><strong>OMB:</strong><br/>
                                                    <input type="text" class="form-control" id="OMB" name="OMB"
                                                           placeholder="OMB">
                                                </div>
                                            </div>
                                            <div class="form-group">
                ...
                <section id="contact" class="home-section bg-white">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10">
                                <form class="form-horizontal" role="form"
                                      action="?perfil=contratados&p=edicaoExecutante&id_pf=<?php echo $ultimo ?>"
                                      method="post">
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8"><strong>Nome *:</strong><br/>
                                            <input type="text" class="form-control" id="Nome" name="Nome"
                                                   placeholder="Nome" value="<?php echo $fisica['Nome']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8"><strong>Nome Artístico:</strong><br/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-md-6"><strong>Documento *:</strong><br/>
                                            <input type="text" class="form-control" id="RG" name="RG"
                                                   placeholder="Documento" value="<?php echo $fisica['RG']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6"><strong>CPF *:</strong><br/>
                                            <input type="text" readonly class="form-control" id="cpf" name="CPF"
                                                   placeholder="CPF" value="<?php echo $fisica['CPF']; ?>">
                                        </div>
                                        <div class="col-md-6"><strong>E-mail *:</strong><br/>
                                            <input type="text" class="form-control" id="Email" name="Email"
                                                   placeholder="E-mail" value="<?php echo $fisica['Email']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6"><strong>Celular *:</strong><br/>
                                            <input type="text" class="form-control" id="telefone"
                                                   onkeyup="mascara( this, mtel );" maxlength="15" name="Telefone1"
                                                   placeholder="Exemplo: (11) 98765-4321"
                                                   value="<?php echo $fisica['Telefone1']; ?>">
                                        </div>
                                        <div class="col-md-6"><strong>Telefone #2:</strong><br/>
                                            <input type="text" class="form-control" id="telefone"
                                                   onkeyup="mascara( this, mtel );" maxlength="15" name="Telefone2"
                                                   placeholder="Exemplo: (11) 98765-4321"
                                                   value="<?php echo $fisica['Telefone2']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6"><strong>Telefone #3:</strong><br/>
                                            <input type="text" class="form-control" id="telefone"
                                                   onkeyup="mascara( this, mtel );" maxlength="15" name="Telefone3"
                                                   placeholder="Exemplo: (11) 98765-4321"
                                                   value="<?php echo $fisica['Telefone3']; ?>">
                                        </div>
                                        <div class="col-md-6"><strong>DRT:</strong><br/>
                                            <input type="text" class="form-control" id="DRT" name="DRT"
                                                   placeholder="DRT" value="<?php echo $fisica['DRT']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8"><strong>Observação:</strong><br/>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8">
                                            <input type="hidden" name="cadastrarFisica"
                                                   value="<?php echo $fisica['Id_PessoaFisica'] ?>"/>
                                            <?php
                                            if (isset($id_pedido)) {
                                                ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-6">
                                        <form class="form-horizontal" role="form" action="?perfil=contratados&p=arqexec"
                                              method="post">
                                            <input type="hidden" name="cadastrarFisica"
                                                   value="<?php echo $fisica['Id_PessoaFisica'] ?>"/>
                                            <input type="hidden" name="idPedido" value="<?php echo $id_pedido ?>"/>
                                    ...
                                    <div class="col-md-6">
                                        <form class="form-horizontal" role="form"
                                            ...
                                            <input type="hidden" name="idPedido"
                                                   value="<?php echo $_SESSION['idPedido']; ?>">
                                            <input type="submit" value="Voltar ao Pedido"
                                                   class="btn btn-theme btn-block"></a>
                                        </form>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                if (isset($id_pedido)) {
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8">
                                            <a href="?perfil=contratados&p=edicaoExecutante&id_pf="><input type="submit"
                                                                                                           value="Mudar o líder do grupo"
                                                                                                           class="btn btn-theme btn-block"></a>
                                        </div>
                                    </div>
                                    <?php
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading">
                            ...
                            <p>Nesta página, você envia documentos digitalizados. O tamanho máximo do arquivo deve ser
                                60MB.</p>
                            <br/>
                            <div class="center">
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading">
                            ...
                            <h5>Se na lista abaixo, o seu arquivo começar com "http://", por favor, clique, grave em seu
                                computador, faça o upload novamente e apague a ocorrência citada.</h5>
                        </div>
                        <div class="table-responsive list_info">
                            <?php
                            include "../funcoes/funcoesSiscontrat.php";
                ...
                <section id="list_items" class="home-section bg-white">
                    <div class="container">
                        ...
                        <div class="table-responsive list_info">
                            ...
                            ?>
                            <div class="col-md-4">
                                <form class="form-horizontal" role="form" action="?perfil=contratados&p=edicaoPedido"
                                      method="post">
                                    <input type="hidden" name="idPedidoContratacao" value="<?php echo $idPedido; ?>">
                                    <input type='submit' class='btn btn-theme btn-block'
                                           value='Voltar ao Pedido de Contratação'></td>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <section id="contact" class="home-section bg-white">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10">
                                <form class="form-horizontal" role="form"
                                      action="?perfil=contratados&p=edicaoGrupo&action=listar" method="post">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8">
                                            <input type="hidden" name="idPedido"
                                                   value="<?php echo $_POST['idPedidoContratacao']; ?>">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        ...
                        <form class="form-horizontal" role="form" action="?perfil=contratados&p=edicaoParcelas"
                              method="post">
                            <?php
                            $soma = 0;
                            for ($i = 1; $i <= $pedido['parcelas']; $i++) {
					...
					AND numero = '$i'";
                                ...
                                if ($evento['ig_tipo_evento_idTipoEvento'] == 4) {
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6 col-sm-1"><strong>Parcela</strong><br/>
                                            <input type='text' disabled name="Valor" id='valor' class='form-control'
                                                   value="<?php echo $i; ?>">
                                        </div>
                                        <div class="col-xs-6 col-sm-2"><strong>Valor</strong><br/>
                                            <input type='text' name="valor<?php echo $i; ?>" id='valor'
                                                   class='form-control valor'
                                                   value="<?php echo dinheiroParaBr($parcela['valor']); ?>">
                                        </div>
                                        <div class="col-xs-6 col-sm-2"><strong>Data Inicial</strong><br/>
                                            <input type='text' name="vigencia_inicio<?php echo $i; ?>"
                                                   id='datepicker1<?php echo $i; ?>' class='form-control datepicker'
                                                   value="<?php echo exibirDataBr($parcela['vigencia_inicio']); ?>">
                                        </div>
                                        <div class="col-xs-6 col-sm-2"><strong>Data Final</strong>
                                            <input type='text' name="vigencia_final<?php echo $i; ?>"
                                                   id='datepicker2<?php echo $i; ?>' class='form-control datepicker'
                                                   value="<?php echo exibirDataBr($parcela['vigencia_final']); ?>">
                                        </div>
                                        <div class="col-xs-6 col-sm-2"><strong>Data Pagamento</strong>
                                            <input type='text' name="vencimento<?php echo $i; ?>"
                                                   id='datepicker3<?php echo $i; ?>' class='form-control datepicker'
                                                   value="<?php echo exibirDataBr($parcela['vencimento']); ?>">
                                        </div>
                                        <div class="col-xs-6 col-sm-2"><strong>Descrição</strong>
                                            <input type='text' name="descricao<?php echo $i; ?>" id=''
                                                   class='form-control' value="<?php echo $parcela['descricao']; ?>">
                                        </div>
                                        <div class="col-xs-6 col-sm-1"><strong>Horas</strong>
                                            <input type='text' name="horas<?php echo $i; ?>" id='horas'
                                                   class='form-control' value="<?php echo $parcela['horas']; ?>">
                                        </div>
                                    </div>
                                    <?php
                                } else {
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-8">
                                    ...
                                    <input type="hidden" name="idPedidoContratacao"
                                           value="<?php echo $_SESSION['idPedido']; ?>"/>
                                    <input type="submit" alt="" name="GRAVAR" value="GRAVAR"
                                           class="btn btn-theme btn-lg btn-block">
                                </div>
                            </div>
                        </form>
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-8">
                                <form method="POST" action="?perfil=contratados&p=edicaoPedido">
                                    ...
                                    <input type='submit' class='btn btn-theme btn-lg btn-block'
                                           value='VOLTAR para área de pedidos de contratação'>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        ...
                        <form class="form-horizontal" role="form" action="?perfil=contratados&p=edicaoVerbas"
                              method="post">
                            <?php
                            $soma = 0;
                            $idPedido = $_SESSION['idPedido'];
                            ...
                            while ($campo_verba = mysqli_fetch_array($query_recupera_verbas)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3"><strong>Valor</strong><br/>
                                        <input type='text' name="<?php echo $campo_verba['idMultiplas']; ?>" id='valor'
                                               class='form-control valor'
                                               value="<?php echo dinheiroParaBr($campo_verba['valor']); ?>">
                                    </div>
                                </div>
                                <?php
                            }
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-8">
                                <a href="?perfil=contratados&p=edicaoPedido" value="VOLTAR"
                                   class="btn btn-theme btn-lg btn-block">VOLTAR para area de pedidos de contratação</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            If ($query2 != '') {
                                ...
                                <div class="col-md-offset-1 col-md-10">
                                    <div class="col-md-offset-2 col-md-8">
                                        <form method='POST'
                                              action='?perfil=compara_pf&busca=<?php echo $fisica['CPF']; ?>'>
                                            <input type='hidden' name='edicaoPessoa' value='1'>
                                            <input type='submit' class='btn btn-theme btn-md btn-block'
                                                   value='Verifique aqui se há atualização no CAPAC'>
                                        </form>
                                        <br/>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-offset-1 col-md-10">
                                <form class="form-horizontal" role="form" onsubmit="return valida()"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-md-6"><strong>CCM *:</strong><br/>
                                            <input type="text" class="form-control" id="CCM" name="CCM"
                                                   placeholder="CCM" value="<?php echo $fisica['CCM']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2  col-md-6"><strong>Data de nascimento:</strong><br/>
                                            <input type="text" class="form-control" id="datepicker01"
                                                   name="DataNascimento" placeholder="Data de Nascimento"
                                                   value="<?php echo exibirDataBr($fisica['DataNascimento']); ?>">
                                        </div>
                                        <div class="col-md-6"><strong>Nacionalidade:</strong><br/>
                                            <input type="text" class="form-control" id="Nacionalidade"
                                                   name="Nacionalidade" placeholder="Nacionalidade"
                                                   value="<?php echo $fisica['Nacionalidade']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2  col-md-8"><strong>CEP:</strong><br/>
                                            <input type="text" class="form-control" id="CEP" name="CEP"
                                                   placeholder="CEP" value="<?php echo $fisica['CEP']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8"><strong>Endereço *:</strong><br/>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6"><strong>Número *:</strong><br/>
                                            <input type="text" class="form-control" id="Numero" name="Numero"
                                                   placeholder="Numero" value="<?php echo $fisica['Numero']; ?>">
                                        </div>
                                        <div class=" col-md-6"><strong>Bairro:</strong><br/>
                                            <input type="text" class="form-control" id="Bairro" name="Bairro"
                                                   placeholder="Bairro">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8"><strong>Complemento *:</strong><br/>
                                            <input type="text" class="form-control" id="Complemento" name="Complemento"
                                                   placeholder="Complemento"
                                                   value="<?php echo $fisica['Complemento']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6"><strong>Cidade *:</strong><br/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-md-6"><strong>Função:</strong><br/>
                                            <input type="text" class="form-control" id="Funcao" name="Funcao"
                                                   placeholder="Função" value="<?php echo $fisica['Funcao']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6"><strong>Inscrição do INSS ou
                                                PIS/PASEP:</strong><br/>
                                            <input type="text" class="form-control" id="InscricaoINSS"
                                                   name="InscricaoINSS" placeholder="Inscrição no INSS ou PIS/PASEP"
                                                   value="<?php echo $fisica['InscricaoINSS']; ?>">
                                        </div>
                                        <div class=" col-md-6"><strong>OMB:</strong><br/>
                                            <input type="text" class="form-control" id="OMB" name="OMB"
                                                   placeholder="OMB" value="<?php echo $fisica['OMB']; ?>">
                                        </div>
                                    </div>
                                    <!-- Dados Bancários -->
                                    <div class="form-group">
                                        <font color="#FF0000"><strong>Pagamentos parcelados ou de valores acima de R$
                                                5.000,00 *SOMENTE COM CONTA CORRENTE NO BANCO DO BRASIL*.<br/></strong></font>
                                        <br/>
                                        <div class="col-md-offset-2 col-md-8"><strong>Banco:</strong><br/>
                                            <select class="form-control" name="codBanco" id="codBanco">
                                                <option value='32'>Banco do Brasil S.A.</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-6"><strong>Agência</strong><br/>
                                            <input type="text" class="form-control" id="agencia" name="agencia"
                                                   placeholder="" value="<?php echo $fisica['agencia']; ?>">
                                        </div>
                                        <div class=" col-md-6"><strong>Conta:</strong><br/>
                                            <input type="text" class="form-control" id="conta" name="conta"
                                                   placeholder="" value="<?php echo $fisica['conta']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8"><strong>Observação:</strong><br/>
                                    ...
                                    <div class="col-md-offset-2 col-md-8">
                                        <form method='POST' action='?perfil=contratados&p=arquivos'>
                                            <input type='hidden' name='idPessoa'
                                                   value='<?php echo $fisica['Id_PessoaFisica'] ?>'>
                                            <input type='hidden' name='tipoPessoa' value='1'>
                                            <input type="submit" value="Anexar arquivos"
                                                   class="btn btn-theme btn-lg btn-block">
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            If ($query2 != '') {
                                ...
                                <div class="col-md-offset-1 col-md-10">
                                    <div class="col-md-offset-2 col-md-8">
                                        <form method='POST'
                                              action='?perfil=compara_pj&busca=<?php echo $juridica['CNPJ']; ?>'>
                                            <input type='hidden' name='edicaoPessoa' value='1'>
                                            <input type='submit' class='btn btn-theme btn-md btn-block'
                                                   value='Verifique aqui se há atualização no CAPAC'>
                                        </form>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8"><strong>Representante legal #01:</strong><br/>
                                        <form class="form-horizontal" role="form" method="post"
                                              action="?perfil=contratados&p=representante&action=edita">
                                            <input type='text' readonly class='form-control' name='representante01'
                                                   id='Executante'
                                                   value="<?php $nome1 = recuperaPessoa($juridica['IdRepresentanteLegal1'], 3);
                                                   echo $nome1['nome']; ?>">
                                            <input type="hidden" name="numero" value="1"/>
                                            <input type="hidden" name="idPessoa"
                                                   value="<?php echo $juridica['IdRepresentanteLegal1'] ?>"/>
                                            <input type="hidden" name="idPessoaJuridica"
                                                   value="<?php echo $juridica['Id_PessoaJuridica'] ?>"/>
                                            <input type="submit" class="btn btn-theme btn-med btn-block"
                                                   value="Abrir Representante legal #01">
                                        </form>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-8">
                                        <form class="form-horizontal" role="form" method="post"
                                            ...
                                            <input type="hidden" name="numero" value="2"/>
                                            <input type="hidden" name="idPessoa"
                                                   value="<?php echo $juridica['IdRepresentanteLegal2'] ?>"/>
                                            <input type="hidden" name="idPessoaJuridica"
                                                   value="<?php echo $juridica['Id_PessoaJuridica'] ?>"/>
                                            <input type='text' readonly class='form-control' name='representante02'
                                                   id='Executante'
                                                   value="<?php $nome2 = recuperaPessoa($juridica['IdRepresentanteLegal2'], 3);
                                                   echo $nome2['nome']; ?>">
                                            <input type="submit" class="btn btn-theme btn-med btn-block"
                                                   value="Abrir Representante legal #02">
                                        </form>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8">
                                    ...
                                    <form class="form-horizontal" role="form" onsubmit="return valida()"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-8"><strong>Razão Social:</strong><br/>
                                                <input type="text" class="form-control" id="RazaoSocial"
                                                       name="RazaoSocial" placeholder="RazaoSocial"
                                                       value="<?php echo $juridica['RazaoSocial']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6"><strong>CNPJ:</strong><br/>
                                                ...
                                                <input type="text" class="form-control" id="CNPJ" name="CNPJ" readonly
                                                       placeholder="CNPJ" value="<?php echo $juridica['CNPJ']; ?>">
                                            </div>
                                            <div class="col-md-6"><strong>CCM:</strong><br/>
                                                <input type="text" class="form-control" id="CCM" name="CCM"
                                                       placeholder="CCM" value="<?php echo $juridica['CCM']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6"><strong>CEP *:</strong><br/>
                                                <input type="text" class="form-control" id="CEP" name="CEP"
                                                       placeholder="CEP" value="<?php echo $juridica['CEP']; ?>">
                                            </div>
                                            <div class=" col-md-6"><strong>Estado *:</strong><br/>
                                                <input type="text" class="form-control" id="Estado" name="Estado"
                                                       placeholder="Estado">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6"><strong>Número *:</strong><br/>
                                                <input type="text" class="form-control" id="Numero" name="Numero"
                                                       placeholder="Numero" value="<?php echo $juridica['Numero']; ?>">
                                            </div>
                                            <div class=" col-md-6"><strong>Complemento:</strong><br/>
                                                <input type="text" class="form-control" id="Complemento"
                                                       name="Complemento" placeholder="Complemento"
                                                       value="<?php echo $juridica['Complemento']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6"><strong>Bairro *:</strong><br/>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6"><strong>Telefone:</strong><br/>
                                                <input type="text" class="form-control" id="telefone"
                                                       onkeyup="mascara( this, mtel );" maxlength="15" name="Telefone1"
                                                       placeholder="Exemplo: (11) 98765-4321"
                                                       value="<?php echo $juridica['Telefone1']; ?>">
                                            </div>
                                            <div class=" col-md-6"><strong>Telefone:</strong><br/>
                                                <input type="text" class="form-control" id="telefone"
                                                       onkeyup="mascara( this, mtel );" maxlength="15" name="Telefone2"
                                                       placeholder="Exemplo: (11) 98765-4321"
                                                       value="<?php echo $juridica['Telefone2']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6"><strong>Telefone:</strong><br/>
                                                <input type="text" class="form-control" id="telefone"
                                                       onkeyup="mascara( this, mtel );" maxlength="15" name="Telefone3"
                                                       placeholder="Exemplo: (11) 98765-4321"
                                                       value="<?php echo $juridica['Telefone3']; ?>">
                                            </div>
                                            <div class=" col-md-6"><strong>E-mail:</strong><br/>
                                                <input type="text" class="form-control" id="Email" name="Email"
                                                       placeholder="E-mail" value="<?php echo $juridica['Email']; ?>">
                                            </div>
                                        </div>
                                        <!-- Dados Bancários -->
                                        <div class="form-group">
                                            <font color="#FF0000"><strong>Pagamentos parcelados ou de valores acima de
                                                    R$ 5.000,00 *SOMENTE COM CONTA CORRENTE NO BANCO DO
                                                    BRASIL*.</strong></font><br/>
                                            <br/>
                                            <div class="col-md-offset-2 col-md-8"><strong>Banco:</strong><br/>
                                                <select class="form-control" name="codBanco" id="codBanco">
                                                    <option value='32'>Banco do Brasil S.A.</option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6"><strong>Agência</strong><br/>
                                                <input type="text" class="form-control" id="agencia" name="agencia"
                                                       placeholder="" value="<?php echo $juridica['agencia']; ?>">
                                            </div>
                                            <div class=" col-md-6"><strong>Conta:</strong><br/>
                                                <input type="text" class="form-control" id="conta" name="conta"
                                                       placeholder="" value="<?php echo $juridica['conta']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-8"><strong>Observações:</strong><br/>
                                                <textarea name="Observacao" class="form-control" rows="10"
                                                          placeholder=""><?php echo $juridica['Observacao']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-8">
                                                <input type="hidden" name="editaJuridica"
                                                       value="<?php echo $juridica['Id_PessoaJuridica'] ?>"/>
                                                <input type="submit" value="GRAVAR"
                                                       class="btn btn-theme btn-lg btn-block">
                                            </div>
            ...
            case 3: ?>
                <section id="contact" class="home-section bg-white">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10">
                                <form class="form-horizontal" role="form" action="?perfil=contratados&p=edicaoPessoa"
                                      method="post">
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-8">
                                            <input type="text" class="form-control" id="RepresentanteLegal"
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading">
                            ...
                            <div class="center">
                                <form method="POST"
                                      action="?perfil=contratados&p=arquivos&idPessoa=<?php echo $_REQUEST['idPessoa']; ?>&tipoPessoa=<?php echo $_REQUEST['tipoPessoa']; ?>"
                                      enctype="multipart/form-data">
                                    <table>
                                        <tr>
                                            <td width="50%">
                                    ...
                                    <input type="hidden" name="tipoPessoa"
                                           value="<?php echo $_REQUEST['tipoPessoa']; ?>"/>
                                    <input type="hidden" name="enviar" value="1"/>
                                    <input type="submit" class="btn btn-theme btn-lg btn-block" value='Enviar'>
                                </form>
                            </div>
        ...
        <section id="contact" class="home-section bg-white">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        <div class="form-group">
                            <form name="form" class="form-horizontal" role="form" onsubmit="return valida()" action="#"
                                  method="post">
                                <hr/>
                                <h6>1º Tópico</h6>
                                <label>Neste tópico deve conter o posicionamento da comissão e as informações gerais do
                                    evento (nome do artista, evento, datas, valor, tempo, etc).</label>
                                <p align="justify"><font color="gray"><strong><i>Texto de exemplo:</strong><br/>Esta
                                        comissão ratifica o pedido de contratação de Nome do artista ou grupo (nome
                                        artístico) por intermédio da Nome da empresa representante, para apresentação
                                        artística no evento “Nome do evento ou atividade especial”, que ocorrerá no dia
                                        datas ou período quando for temporada no valor de R$ XXX (valor por
                                        extenso).</font></i></p>
                                <?php
                                if ($parecer['topico1'] == NULL) {
                                    ?>
                                    <textarea name="topico1" id="topico1" class="form-control"
                                              rows="3"><?php echo $t1; ?></textarea>
                                    <?php
                                } else {
                                    ?>
                                    <textarea name="topico1" id="topico1" class="form-control"
                                              rows="3"><?php echo $parecer["topico1"]; ?></textarea>
                                    <?php
                                }
                                ?>
                                ...
                                <label>Neste tópico deve-se falar sobre o evento ou atividade especial da qual o
                                    artista/grupo irá participar. Se for programação geral do equipamento, sem estar
                                    vinculada a nenhum evento ou projeto específico, falar sobre o equipamento,
                                    histórico, tipo de atividades desenvolvidas, etc, demonstrando a importância desse
                                    tipo de programação dentro do equipamento.</label>
                                <p align="justify"><font color="gray"><strong><i>Texto de exemplo:</strong><br/>Em sua
                                        nona edição, o projeto Virada Cultural, da Secretaria Municipal de Cultura,
                                        consolida a Cidade de São Paulo como o principal pólo gerador de arte e cultura
                                        do País proporcionando, não só aos munícipes como também aos visitantes de
                                        outros Estados e de outras nacionalidades, o acesso gratuito ao que há de melhor
                                        na produção cultural atual existente no Brasil e no exterior. A Virada Cultural
                                        da Cidade de São Paulo, através de apresentações artísticas em logradouros
                                        públicos e equipamentos oficiais dentre outros espaços culturais conquistou,
                                        nesses nove anos de existência, o reconhecimento da mídia e do público,
                                        solidificando-se como um dos eventos nacionais mais conhecidos e divulgados do
                                        Brasil, assim como no exterior.</font></i></p>
                                <textarea cols="45" name="topico2" id="topico2" rows="10" class="form-control"
                                ...
                                if ($pedido['TipoPessoa'] == 2) {
                                    ?>
                                    <label>Neste tópico deve-se falar sobre o currículo/biografia do artista ou grupo
                                        (na 3ª pessoa), escrever um breve release. Deve ficar claro que o artista
                                ...
                                <textarea cols="45" name="topico3" id="topico3" rows="10" class="form-control"
                                ...
                                if ($artista == "Local") {
                                    ?>
                                    <label>Neste tópico deve-se falar que o contratado tem o necessário para a
                                        contratação e que as exigências legais foram observadas, apresentando a
                                        comprovação documental (mínimo três comprovações diferentes) do valor proposto
                                        para o cachê. Encerrar com a manifestação favorável da comissão quanto à
                                        contratação.</label>
                                    <p align="justify"><font color="gray"><strong><i>Texto de exemplo:</strong><br/>Os
                                            artistas reúnem as condições necessárias para integrar a programação
                                            Secretaria Municipal de Cultura, possuem consagração, reconhecimento e
                                            aceitação do público, conforme documentos juntados ao presente, SEI ( link
                                            do clipping, curriculo e release ). Ainda, avaliamos que o cachê proposto
                                            encontra-se compatível com os valores praticados no mercado e pagos por esta
                                            Secretaria, conforme pode ser comprovado pelos processos/notas fiscais (
                                            link de 3 números de processos SEI que constem notas fiscais ), em
                                            cumprimento ao Acórdão TC 2.393/15-37.
                                            <br/>
                                            Sendo os serviços indubitavelmente de natureza artística, manifestamo-nos
                                            favoravelmente à contratação, endossando a proposta inicial.</font></i></p>
                                    <?php
                                } else {
                                    ?>
                                    <label>Neste tópico deve-se falar que o contratado tem o necessário para a
                                        contratação e que as exigências legais foram observadas, apresentando a
                                        comprovação documental (mínimo três notas fiscais de eventos que não foram
                                        contratados pela prefeitura) do valor proposto para o cachê. Encerrar com a
                                        manifestação favorável da comissão quanto à contratação.</label>
                                    <p align="justify"><font color="gray"><strong><i>Texto de exemplo:</strong><br/>O
                                            espetáculo é composto por profissionais consagrados pelo público e pela
                                            crítica especializada, estando o cachê proposto de acordo com os valores
                                            praticados no mercado, conforme pode ser comprovado pelos documentos x, y e
                                            z, em cumprimento ao Acórdão TCM 2.393/15-37.
                                            <br/>
                                            Sendo os serviços indubitavelmente de natureza artística, manifestamo-nos
                                            favoravelmente à contratação, endossando a proposta inicial.</font></i></p>
                                    <?php
                                ...
                                ?>
                                <textarea name="topico4" class="form-control"
                                          rows="10"><?php echo $parecer["topico4"]; ?></textarea>
                        ...
                        if ($parecer == NULL) {
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-8">
                                    <input type="hidden" name="insereParecer"
                                           value="<?php echo $parecer['idParecer'] ?>"/>
                                    <input type="submit" value="GRAVAR" class="btn btn-theme btn-lg btn-block">
                                </div>
                            </div>
                            <?php
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-8">
                                <form class="form-horizontal" role="form" action="?perfil=contratados&p=edicaoPedido"
                                    ...
                                    <input type="submit" value="Voltar à edição do Pedido"
                                           class="btn btn-theme btn-lg btn-block">
                                </form>
                            </div>
                        </div>
