...
{ ?>
	<section id="services" class="home-section bg-white">
        ...
        <div class="col-md-offset-2 col-md-8">
            ...
            <form method="POST" action="?perfil=publicacao&p=frm_busca_formacao" class="form-horizontal" role="form">
...
<br />
	<section id="list_items">
		<div class="container">
             ...
             <h5><a href="?perfil=publicacao&p=frm_busca_formacao">Fazer outra busca</a></h5>
