	    ...
	    <div class="row">
			<div class="col-md-offset-2 col-md-8"><hr/>
				<div class="section-heading">                    
					...
					<br />
					<div class = "center">
						<form method="POST" action="?perfil=contratos_lite&p=frm_arquivos_pedidos&id_ped=<?php echo $_GET['id_ped']; ?>" enctype="multipart/form-data">
						<table>
							<tr>
								<td width="50%"><td>
							</tr>
            ...
            <?php 
			 ...
			 ?>       
				<a href="?perfil=contratos_lite&p=frm_edita_proposta<?php echo $pes ?>&id_ped=<?php echo $_SESSION['idPedido'];  ?>" class="btn btn-theme btn-block" >Voltar ao Pedido</a>	
