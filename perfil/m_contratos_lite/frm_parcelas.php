...
<section id="contact" class="home-section bg-white">
	<div class="container">
		<div class="form-group">
			<h4>PEDIDO DE CONTRATAÇÃO <?php if($pedido['tipoPessoa'] == 1){echo "PESSOA FÍSICA";}else{echo "PESSOA JURÍDICA";} ?> </h4>
		...
		<div class="row">
	  		<div class="col-md-offset-1 col-md-10">
				...
				<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_parcelas" method="post">
				<?php
					$soma = 0;
					for($i = 1; $i <= $pedido['parcelas']; $i++)
					{
				 ...
				 ?>
						<div class="form-group">
							<div class="col-md-offset-2 col-sm-1"><strong>Parcela</strong><br/>
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
						<?php
						 ...
						 ?>
						<a href="?perfil=contratos_lite&p=frm_edita_proposta<?php echo $pfpj ?>&id_ped=<?php echo $_SESSION['idPedido']; ?>" value="VOLTAR" class="btn btn-theme btn-lg btn-block">VOLTAR para area de pedidos de contratação</a>
					</div>
				</div>	
	  		</div>
		</div>
