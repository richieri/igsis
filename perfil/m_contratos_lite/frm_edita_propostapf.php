		...
		<div class="form-group">
	  	...
	  	<div class="row">
	  		<div class="col-md-offset-1 col-md-10">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					<form class="form-horizontal" role="form" action="<?php echo "?perfil=contratos_lite&p=frm_edita_pf&id_pf=".$linha_tabelas['IdProponente']."&id_ped=".$id_ped; ?>" method="post">
				...
				<!-- Atualiza Grupo -->			  
				<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_edita_propostapf&id_ped=<?php echo $id_ped; ?>&idEvento=<?php echo $pedido['idEvento']; ?>" method="post">
				<div class="form-group">
