	  	...
	  	<div class="container">
	  		...
	  		<div class="row">
                  ...
                  <div class="form-group"> 
					<div class="col-md-offset-2 col-md-8"><strong>Proponente:</strong><br/>
                  	...
                  	<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					  <form class="form-horizontal" role="form" action="<?php echo "?perfil=contratos_lite&p=frm_edita_pf&id_pf=".$linha_tabelas['IdProponente']; ?>" method="post">
			 ...
			 <a href="?perfil=contratos_lite&p=frm_chamados&pag=evento&idEvento=<?php echo $pedido['idEvento'];  ?>" class="btn btn-theme btn-block" target="_blank" >Chamados</a></div>	
					...
					$dados = siscontrat($outros[$i]);
						?>
            <p align="left">
            Número do Pedido de Contratação:<b> <a href="?perfil=contratos_lite&p=frm_edita_propostapf&id_ped=<?php echo $outros[$i]; ?>"></b><?php echo $outros[$i]; ?></a><br />
			</p>
            <?php 
