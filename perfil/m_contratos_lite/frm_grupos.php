...
<section id="list_items" class="home-section bg-white">
			...
			<div class="table-responsive list_info">
				...
				?>	
						<tr>
							...
							<form method='POST' action='?perfil=contratos_lite&p=frm_grupos&action=editar&idGrupo=<?php echo $grupo['idGrupos'] ?>'>
								<input type="hidden" name="editar" value="<?php echo $grupo['idGrupos'] ?>" />
								<input type ='submit' class='btn btn-theme btn-block' value='editar'>
								</form>
							</td>
							<td class='list_description'>
							<form method='POST' action='?perfil=contratos_lite&p=frm_grupos'>
	...
	?>
            <div class="col-md-offset-2 col-md-8">
                ...
                <a href="?perfil=contratos_lite&p=frm_grupos&action=inserir">Clique aqui para inserir</a>.</h3>				
            </div> 
	<?php 
		}
	?>
            <div class="col-md-offset-2 col-md-8">
				<a href="?perfil=contratos_lite&p=frm_grupos&action=inserir" class="btn btn-theme btn-md btn-block">Inserir outro integrante</a>
            	<?php 
					$pedido = recuperaDados("igsis_pedido_contratacao",$_SESSION['idPedido'],"idPedidoContratacao");
					if($pedido['tipoPessoa'] == 2)
					{
				?>        
						<a href="?perfil=contratos_lite&p=frm_edita_propostapj&id_ped=<?php echo $_SESSION['idPedido'] ?>" class="btn btn-theme btn-md btn-block">Voltar ao pedido</a>
				<?php 
					}
					else
					{ 
				?>
						<a href="?perfil=contratos_lite&p=frm_edita_propostapf&id_ped=<?php echo $_SESSION['idPedido'] ?>" class="btn btn-theme btn-md btn-block">Voltar ao pedido</a>
				<?php 
					} 
				?>
	        </div>        	   
  	...
  	<div class="container">
		<div class="form-group">
  		...
  		<div class="row">
			...
			<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_grupos&action=listar" method="post">
                <div class="form-group">
...
<section id="contact" class="home-section bg-white">
 	<div class="container">
		...
		<div class="row">
	  		<div class="col-md-offset-1 col-md-10">
			<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_grupos&idGrupo=<?php echo $idGrupo ?>" method="post">
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8"><strong>Nome completo: *</strong><br/>
