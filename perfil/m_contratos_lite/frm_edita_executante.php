...
<section id="services" class="home-section bg-white">
	<div class="container">
	    ...
	    <div class="row">
		<form method="POST" action="?perfil=contratos_lite&p=frm_edita_executante&id_pf=" class="form-horizontal" role="form">
			...
			<div class="table-responsive list_info">
				<table class="table table-condensed">
					...
					{			
						...
						<form method='POST' action='?perfil=contratos_lite&p=frm_edita_propostapj&id_ped=".$_SESSION['idPedido']."'>
	...
	<section id="contact" class="home-section bg-white">
		<div class="container">
			<div class="form-group">
				...
				<p><a href="?perfil=contratos_lite&p=frm_edita_executante&id_pf="> Pesquisar outro CPF</a> </p>
			</div>
			<div class="row">
			<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_edita_propostapj&id_ped=<?php echo $_SESSION['idPedido'] ?>" method="post">
...
<section id="contact" class="home-section bg-white">
  	<div class="container">
		<div class="form-group">
			<h4>CADASTRO DE EXECUTANTE (PESSOA FÍSICA)</h4>
            <h5><?php if(isset($mensagem)){echo $mensagem;} ?></h5>
        </div>
  		<div class="row">
	  		<div class="col-md-offset-1 col-md-10">
			<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_edita_executante&id_pf=<?php echo $ultimo ?>" method="post">
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8"><strong>Nome *:</strong><br/>
				...
				<div class="form-group">
					...
					<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_arquivos&idPessoa=<?php echo $ultimo; ?>&tipoPessoa=1&id_ped=<?php echo $id_ped ?>" method="post">
						<input type="hidden" name="cadastrarFisica" value="<?php echo $fisica['Id_PessoaFisica'] ?>" />
						<input type="hidden" name="idPedido" value="<?php echo $id_pedido ?>" />
			...
			?>        
					<div class="form-group">
						<div class="col-md-offset-2 col-md-8">
							<a href="?perfil=contratos_lite&p=frm_edita_executante&id_pf="><input type="submit" value="Mudar o executante" class="btn btn-theme btn-block"></a>
						</div>
					</div>
            <?php 
				} 
