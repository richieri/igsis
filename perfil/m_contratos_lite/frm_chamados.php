	...
	<div class="container">
		...
		<div class="table-responsive list_info">
			...
			if(isset($_GET['f']))
			{
				...
				{ 
			?>
		            <h5>Filtrar : [ Abertos ] [ <a href="?perfil=contratos_lite&p=frm_chamados&f=2">Fechados</a> ] [ <a href="?perfil=contratos_lite&p=frm_chamados">Todos </a>]</h5>
					
			<?php 
				} elseif ($_GET['f'] == 2)
				{ 
			?>
		            <h5>Filtrar : [ <a href="?perfil=contratos_lite&p=frm_chamados&f=1">Abertos</a> ] [ Fechados ] [ <a href="?perfil=contratos_lite&p=frm_chamados">Todos </a>]</h5>
			...
			{
				$f = ""; ?>
				<h5>Filtrar : [ <a href="?perfil=contratos_lite&p=frm_chamados&f=1">Abertos</a> ] [ <a href="?perfil=contratos_lite&p=frm_chamados&f=2">Fechados</a> ] [ Todos ]</h5>
			<?php 
			}
			?>
			...
			<table class='table table-condensed'>
				...
				?>
							<tr>
								...
								<td><a href="?perfil=contratos_lite&p=frm_chamados&pag=editar&id=<?php echo $chamado['idChamado'] ?>" target="_blank" ><?php echo $tipo['chamado']." - ".$chamado['titulo']; ?>
								<?php
...
<section id="chamado" class="home-section bg-white">
    <div class="container">
		...
		<div class="row">
		<form method="POST" action="?perfil=contratos_lite&p=frm_chamados&pag=editar&id=<?php echo $idChamado; ?>" class="form-horizontal" role="form">
