...
<section id="contact" class="home-section bg-white">
	<div class="container">
		...
		<div class="row">
			...
			<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_edita_pf&id_pf=<?php echo $ultimo ?>" method="post">
				<div class="form-group">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-6"><strong>CPF *:</strong><br/>
						<input type="text" class="form-control" readonly id="cpf" name="CPF" placeholder="CPF" value="<?php echo $fisica['CPF']; ?>">
					</div>				  
				...
				<div class="form-group">
					...
					<?php 
						...
						{ 
					?>
							<a href="?perfil=contratos_lite&p=frm_edita_propostapf&id_ped=<?php echo $id_pedido ?>"><input type="submit" value="Voltar ao pedido" class="btn btn-theme btn-block"></a>
					<?php 
						} 
						elseif($id_ped <> "")
						{ 
					?>
							<a href="?perfil=contratos_lite&p=frm_edita_propostapf&id_ped=<?php echo $id_ped ?>"><input type="submit" value="Voltar ao pedido" class="btn btn-theme btn-block"></a>
					<?php 
						} 
					?>
					</div>
