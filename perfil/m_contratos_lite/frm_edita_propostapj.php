...
$link1="index.php?perfil=contratos_lite&p=impressao_contratos_pj&id_ped=".$id_ped;
...
<?php include 'includes/menu.php';?>
	 ...
	 <!-- Contact -->
	  <section id="contact" class="home-section bg-white">
	  	<div class="container">
	  		...
	  		<div class="row">
                  ...
                  <div class="form-group"> 
                    ...
                    <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					  <form class="form-horizontal" role="form"  method="post" action="?perfil=contratos_lite&p=frm_edita_pj&id_pj=<?php echo $ped['idPessoa']; ?>">
		  ...
		  <form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_edita_executante&id_pf=<?php echo $pedido['IdExecutante']?>"  method="post">
		  ...
		  <form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_grupos"  method="post">
				...
				<?php } ?>   	
				  ...
				  if($pedido['parcelas'] > 1){ //libera a edição de parcelas
				   ?>
                    <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					  <a href="?perfil=contratos_lite&p=frm_parcelas" class="btn btn-theme btn-block">Editar parcelas</a>
					</div>
			 ...
			 <a href="?perfil=contratos_lite&p=evento&id_ped=<?php echo $pedido['idEvento'];  ?>" class="btn btn-theme btn-block" target="_blank" >Abrir detalhes do evento</a></div>
                  					
					<div class="col-md-6">
			 <a href="?perfil=contratos_lite&p=frm_arquivos_pedidos&id_ped=<?php echo  $_GET['id_ped']; ?>" class="btn btn-theme btn-block" target="_blank" >Abrir Anexos do Pedido</a></div>	
				</div>
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
			 <a href="../perfil/m_contratos_lite/frm_arquivos_todos.php?idPedido=<?php echo $_GET['id_ped'];  ?>&all=true" class="btn btn-theme btn-block" >Baixar todos os arquivos do pedido e do proponente</a></div>	
			</div>
					<div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                    	<br />
                    ...
                    <div class="col-md-offset-2 col-md-8">
                    	<br />
                				...
                				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
			 <a href="?perfil=contratos_lite&p=frm_chamados&pag=evento&idEvento=<?php echo $pedido['idEvento'];  ?>" class="btn btn-theme btn-block" target="_blank" >Chamados</a></div>	
			</div>
					<div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                    	<br />
