	...
	<div class="container">
		...
		<div class="row">
	  		<div class="col-md-offset-1 col-md-10">	
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					<form class="form-horizontal" role="form"  method="post" action="?perfil=contratos_lite&p=frm_edita_pj&id_pj=<?php echo $ped['idPessoa']; ?>&id_ped=<?php echo $id_ped ?>">
                ...
                <div class="form-group"> 
					...
					<form class="form-horizontal" role="form" action="?perfil=contratos_lite&p=frm_edita_executante&id_pf=<?php echo $pedido['IdExecutante']?>&id_ped=<?php echo $id_ped ?>"  method="post">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-6">
						<a href="?perfil=contratos_lite&p=evento&id_ped=<?php echo $pedido['idEvento'];  ?>" class="btn btn-theme btn-block" target="_blank" >Abrir detalhes do evento</a>
					</div>                  					
					<div class="col-md-6">
