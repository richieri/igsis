...
case "evento":
 ...
 ?>
	<h5>Dados do evento | <a href="?perfil=contratos_lite&p=evento&action=servicos&id_ped=<?php echo $_GET['id_ped']; ?>">Solicitação de serviços</a> | <a href="?perfil=contratos_lite&p=evento&action=pedidos&id_ped=<?php echo $_GET['id_ped']; ?>">Pedidos de contratação</a>  | 
	...
	<div class="table-responsive list_info" >
		<h4></h4>
		<p align="left"><?php descricaoEvento($_GET['id_ped']); ?></p>      
		
		<h5>Ocorrências</h5>
		<?php echo resumoOcorrencias($_GET['id_ped']); ?>
		<br /><br />
		...
		?>
			<h5>Sub-eventos</h5>
				<div class="left"><?php listaSubEventosCom($idEvento) ?></div>
		<?php 
			} 
		?>
...
?>
	<h5> <a href="?perfil=contratos_lite&p=evento&action=evento&id_ped=<?php echo $_GET['id_ped']; ?>">Dados do evento </a> |<a href="?perfil=contratos_lite&p=evento&action=servicos&id_ped=<?php echo $_GET['id_ped']; ?>">Solicitação de serviços</a> | Pedidos de contratação | 
...
case "servicos":
?>    
	<h5><a href="?perfil=contratos_lite&p=evento&action=evento&id_ped=<?php echo $_GET['id_ped']; ?>">Dados do evento </a>| Solicitação de serviços | <a href="?perfil=contratos_lite&p=evento&action=pedidos&id_ped=<?php echo $_GET['id_ped']; ?>">Pedidos de contratação</a>| 
	...
	<div class="table-responsive list_info" >
		...
		<div class="left">	
			...
			<?php listaServicosExternos($_GET['id_ped']); ?>			
			<br /><br />
