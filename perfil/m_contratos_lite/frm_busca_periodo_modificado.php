...
$i = 0;
	while($evento = mysqli_fetch_array($query_evento)){
		...
		if($event['dataEnvio'] != NULL AND $event['publicado']){ // se o evento estiver publicado e tiver sido enviado 
			...
			$x[$i]['processo'] = $pedido['NumeroProcesso'];		
			$i++;
...
<br />
	<section id="list_items">
		<div class="container">
             ...
             <h5><a href="?perfil=contratos&p=frm_busca_periodo_modificado">Fazer outra busca</a></h5>
...
for($h = 0; $h < $x['num']; $h++)
 {
	...
	echo '<td class="list_description">'.$x[$h]['processo'].						'</td> </tr>';
...
?>
	 ...
	 <section id="services" class="home-section bg-white">
		<div class="container">
            ...
            <form method="POST" action="?perfil=contratos&p=frm_busca_periodo_modificado" class="form-horizontal" role="form">
                <div class="form-group">
