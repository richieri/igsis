...
if (isset($_POST['filtrar'])) {
    ...
    if ($usuario != '') {
        $sql_user = "SELECT * FROM ig_usuario WHERE nomeCompleto = '$usuario'";
...
<section id="list_items" class="home-section bg-white">
    <div class="container">
        ...
        <form method="POST" action="?perfil=agendao&p=agendao_filtro_excel" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-offset-3 col-md-3">
                        ...
                        <input type="text" name="inicio" class="form-control" id="datepicker01" onchange="desabilitaFiltrar()" placeholder="">
                    </div>
                    <div class="col-md-3">
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-8">
                    <br/>
                    <input type="submit" class="btn btn-theme btn-block" name="filtrar" id="filtrar" value="Filtrar" disabled>
                    <br>
                </div>
            </div>
        </form>
