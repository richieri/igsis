		...
		<div class='col-md-offset-1 col-md-10'>
			<div class='form-group'>
				<div class='col-md-offset-2 col-md-6'>
					<a href='$link1?id=$id_ped' class='btn btn-theme btn-md btn-block' target='_blank'>Pedido Integral</a></div>
				<div class='col-md-6'>
					<a href='$link2' class='btn btn-theme btn-md btn-block' target='_blank'>Pedido Parcelado</a><br/></div>
			</div>
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-5"><strong>Responsável no Setor de Pagamentos:</strong><br/>
						<select class="form-control" name="pagamentos" id="">
							...
							$sql_operador = "SELECT * FROM ig_usuario WHERE idUsuario IN (270, 274, 275, 393, 424, 445, 655, 993, 1010, 1135, 1170, 1256, 1257, 1295, 872, 1296, 1297, 1126, 147, 1081, 986, 895) ORDER BY nomeCompleto";
