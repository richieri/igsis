	 ...
	 <section id="services" class="home-section bg-white">
		<div class="container">
            ...
            <h5><?php if(isset($mensagem)){ echo $mensagem; } ?>
                      <form method="POST" action="?perfil=pagamento&p=frm_concluir_processo" class="form-horizontal" role="form">
...
<br />
	<section id="list_items">
		<div class="container">
             ...
             <h5><a href="?perfil=pagamento&p=frm_concluir_processo">Fazer outra busca</a></h5>
...
for($h = 0; $h < $x['num']; $h++)
 {
	...
	if($x[$h]['tipo'] == 'Física'){
		echo "<tr><td class='lista'> <a href='?perfil=pagamento&p=frm_concluir_processo_pf&id_ped=".$x[$h]['id']."'>".$x[$h]['NumeroProcesso']."</a></td>";
	}else{
		echo "<tr><td class='lista'> <a href='?perfil=pagamento&p=frm_concluir_processo_pj&id_ped=".$x[$h]['id']."'>".$x[$h]['NumeroProcesso']."</a></td>";
...
<?php
	...
	<?php  geraOpcao("ig_modalidade","",""); ?>
            ...
            <div class="form-group">
            	<div class="col-md-offset-2 col-md-8">
            <h5><?php if(isset($mensagem)){ echo $mensagem; } ?>
            <form method="POST" action="?perfil=pagamento&p=frm_concluir_processo&b=periodo" class="form-horizontal" role="form">
                <div class="form-group">
...
<br />
	<section id="list_items">
		<div class="container">
			 <h3>Resultado da busca</3>
             <h5>Foram encontrados <?php echo $x['num']; ?> pedidos de contratação.</h5>
             <h5><a href="?perfil=pagamento=frm_concluir_processo">Fazer outra busca</a></h5>
			<div class="table-responsive list_info">
				<table class="table table-condensed">
					<thead>
						<tr class="list_menu">
