...
$sql_operador = "SELECT * FROM ig_usuario WHERE idUsuario IN (270, 274, 275, 393, 424, 445, 655, 993, 1081, 1135, 1256, 1293, 1429, 1440, 1468, 1516, 1534) ORDER BY nomeCompleto";
 ?>
