...
$sql_operador = "SELECT * FROM ig_usuario WHERE idUsuario IN (270, 274, 275, 393, 424, 445, 655, 993, 1121, 1135, 1170, 1256, 1293, 872, 1296, 1126, 1081, 986, 895, 1429, 1440, 1455) ORDER BY nomeCompleto";
 ?>
