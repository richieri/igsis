...
<section id="contact" class="home-section bg-white">
    <div class="container">
        ...
        <div class="form-group">
			...
			<div class="form-group">
            <div class="col-md-offset-2 col-md-8"><a href="?perfil=juridico&p=frm_edita_juridico_pj&id_ped=<?php echo $id_ped ?>" class="btn btn-theme btn-lg btn-block">Editar</a>
			</div>
			<div>
        </div>
    </div>
