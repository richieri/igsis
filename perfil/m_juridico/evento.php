...
case "evento":
 ...
 ?>
	<h5>Dados do evento | <a href="?perfil=juridico&p=evento&action=servicos&id_ped=<?php echo $_GET['id_ped']; ?>">Solicitação de serviços</a> | <a href="?perfil=juridico&p=evento&action=pedidos&id_ped=<?php echo $_GET['id_ped']; ?>">Pedidos de contratação</a>  | 
...
?>
	<h5> <a href="?perfil=juridico&p=evento&action=evento&id_ped=<?php echo $_GET['id_ped']; ?>">Dados do evento </a> |<a href="?perfil=juridico&p=evento&action=servicos&id_ped=<?php echo $_GET['id_ped']; ?>">Solicitação de serviços</a> | Pedidos de contratação | 
...
case "servicos":
?>    
	<h5><a href="?perfil=juridico&p=evento&action=evento&id_ped=<?php echo $_GET['id_ped']; ?>">Dados do evento </a>| Solicitação de serviços | <a href="?perfil=juridico&p=evento&action=pedidos&id_ped=<?php echo $_GET['id_ped']; ?>">Pedidos de contratação</a>| 
