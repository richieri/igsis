		  ...
		  <form class="form-horizontal" role="form" action="?perfil=contratados&p=edicaoGrupo"  method="post">
		   ...
		   <?php }
				...
				{ ?>
                  <div class="form-group">
					<div class="col-md-offset-2 col-md-8"><strong>Valor:</strong><br/>
					  <input type='text' name="Valor" id='valor' class='form-control' value="" disabled="disabled"<?php echo dinheiroParaBr($pedido['valor']) ?>" >
					</div>					
				<?php } ?>
				...
				<?php } ?>   				  
                  <div class="form-group">
					<div class="col-md-offset-2 col-md-8"><strong>Parcelas (antes de editar as parcelas, é preciso salvar o pedido)</strong><br/>
					  	<select class="form-control" id="parcelas" name="parcelas" disabled="disabled" >
			...
			<?php } ?>
				  ...
				  ?>
					<div class="col-md-offset-2 col-md-8"><strong>Verba: <font color="blue"><?php echo $campo_verba; ?> (atual)</font>
					    ...
					    <option value="75" <?php if($pedido['idVerba'] == 75) {echo "selected";} ?>>Doação de Serviços</option>
                        <option value="7" <?php if($pedido['idVerba'] == 7) {echo "selected";} ?>>Parceria</option>
                        <option value="91" <?php if($pedido['idVerba'] == 91) {echo "selected";} ?>>Reversão de Bilheteria</option>
