	...
	<div class="container">
		...
		?>
					<tr>
						...
						<td>
							<a href="?perfil=chamado&p=detalhe&id=<?php echo $chamado['idChamado'] ?>" ><?php echo $tipo['chamado']." - ".$chamado['titulo']; ?>
			<?php
	...
	<div class="container">
		...
		<?php
			...
			switch($action)
			{
				case "evento":
		?>
		<h5>Dados do evento | <a href="?perfil=producao&p=detalhe&action=servicos&id_ped=<?php echo $_GET['id_ped']; ?>">Solicitação de serviços</a>  | 
				<?php 
					if($chamado['numero'] == '0')
					{
						echo "Chamados [0]";
