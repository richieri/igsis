...
if(isset($_POST['periodo']))
{
	...
	$con = bancoMysqli();
	$sql_evento = "SELECT idEvento, MIN(data) FROM igsis_agenda WHERE data BETWEEN '$inicio' AND '$final' GROUP BY idEvento ORDER BY data ASC ";
...
<br />
	<section id="list_items">
		<div class="container">
             ...
             <h5><a href="?perfil=contratos&p=frm_busca_periodo_min">Fazer outra busca</a></h5>
...
?>
	 ...
	 <section id="services" class="home-section bg-white">
		<div class="container">
            ...
            <form method="POST" action="?perfil=contratos&p=frm_busca_periodo_min" class="form-horizontal" role="form">
                <div class="form-group">
