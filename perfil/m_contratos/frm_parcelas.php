				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
						<?php
						 ...
						 ?>
						<a href="?perfil=contratos&p=frm_edita_proposta<?php echo $pfpj ?>&id_ped=<?php echo $_SESSION['idPedido']; ?>" value="VOLTAR" class="btn btn-theme btn-lg btn-block">VOLTAR para area de pedidos de contratação</a>
					</div>
				</div>	
	  		</div>
		</div>
