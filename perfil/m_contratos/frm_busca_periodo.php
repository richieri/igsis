		...
		if($dataInicio >= strtotime($inicio) AND $dataInicio <= strtotime($final))
		{
			...
			{ // se o evento estiver publicado e tiver sido enviado 
				...
				while($pedido = mysqli_fetch_array($query_pedido))
				{
					...
					if ( $pedido ['estado'] == 1 OR $pedido ['estado'] == 2 OR 	$pedido ['estado'] == 3 OR $pedido ['estado'] == 4 OR $pedido ['estado'] == 5 OR $pedido ['estado'] == 6 OR $pedido ['estado'] == 7 OR $pedido ['estado'] == 8 OR $pedido ['estado'] == 9 OR $pedido ['estado'] == 10 OR $pedido ['estado'] == 11 OR $pedido ['estado'] == 13 OR $pedido ['estado'] == 14 OR $pedido ['estado'] == 15 OR $pedido ['estado'] == 18) 
					{
