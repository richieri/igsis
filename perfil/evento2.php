...
require_once("../funcoes/funcoesSiscontrat.php");
	...
	$pedidos = verificaPedidosContratacao($_SESSION['idEvento']);
...
<p>
<?php //print_r($evento);
if($pedidos['n_pedidos'] > 0){
	if($pedidos['total'] > 0){
	echo "<h4>Há campos obrigatórios não preenchidos nos pedidos de contratação.</h4>";	
	echo "<strong>".substr($pedidos['campos'],1)."</strong>"; 
	echo "<br /><br />";
	}
}else{
...
<br /><br />
            ...
            <br />
<?php 
// Libera o botão de envio
if($pedidos['total'] == 0 AND
	$campos['total'] == 0 AND
	$ocorrencia > 0 AND 
	$prazo['fora'] == 0){
