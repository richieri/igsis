	...
	<div class="container">
		...
		<div class="table-responsive list_info">
			...
			<?php					
				$con = bancoMysqli();
				$sql_busca_dic = "
                    SELECT DISTINCT age.idEvento FROM igsis_agenda AS age 
                    INNER JOIN ig_evento AS eve ON age.idEvento = eve.idEvento 
                    WHERE eve.publicado = 1 AND data <= '$data_final' AND data >= '$data_inicio' AND dataEnvio IS NOT NULL
                    ORDER BY data";
