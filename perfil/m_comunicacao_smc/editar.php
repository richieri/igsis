    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-offset-1 col-md-10">
                <form method="POST" action="?perfil=comunicacao_smc&p=editar&idCom=<?php echo $_GET['idCom'] ?>" class="form-horizontal" role="form">
                    <div class="form-group">
                        <div class="col-md-offset-1 col-md-10">
                            <h6><a href="?perfil=busca&p=detalhe&evento=<?php echo $campo['ig_evento_idEvento'] ?>" target="_blank">Documento enviado </a> | Edição |
                            <?php
                                if($chamado['numero'] == '0')
                                {
                                    echo "Chamados [0]";
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-1 col-md-10">
                            ...
                            <input type="text" name="nomeEvento" class="form-control" id="inputSubject" value="<?php echo $campo['nomeEvento'] ?>" readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-offset-1 col-md-10">
                            <label>Projeto especial</label>
                            <select class="form-control" name="projetoEspecial" id="inputSubject" readonly>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-1 col-md-10">
                            ...
                            <select class="form-control" name="ig_tipo_evento_idTipoEvento" id="inputSubject" readonly>
                                <option value="1"></option>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-1 col-md-10"><strong>Ficha Técnica:</strong><br/>
                            <textarea name="fichaTecnica" class="form-control" rows="10" readonly><?php echo $campo['fichaTecnica'] ?></textarea>
                        </div>
                    </div>
					<div class="form-group">
                        <div class="col-md-offset-1 col-md-10"><strong>Sinopse:</strong><br/>
							<textarea name="sinopse" class="form-control" rows="12" ><?php echo $campo['sinopse'] ?></textarea>
						</div>
					</div>	
					<div class="form-group">
                        <div class="col-md-offset-1 col-md-10"><strong>Release:</strong><br/>
			...
			?>
					<div class="form-group">
                        <div class="col-md-offset-1 col-md-10"><strong>Gerador de Diagramação</strong><br/>
							<div class="left">
					...
					?>
					<div class="form-group">
                        <div class="col-md-offset-1 col-md-10"><strong>Observação:</strong><br/>
							<textarea name="observacao" class="form-control" rows="5" ><?php echo $campo['observacao'] ?></textarea>
						</div>
					</div>
					<div class="form-group">
                        <div class="col-md-offset-1 col-md-10">
