	...
	<div class="container">
		...
		<div class="form-group">
			...
			<?php
				...
				{
					$con = bancoMysqli();
					$sql_existe = "SELECT * FROM ig_evento WHERE publicado = '1' idEvento = $id AND dataEnvio IS NOT NULL";
					...
					{ //Não foi inserido o número do evento
						...
						$localUsr = $usr['local'];
						$sql_evento = "SELECT * FROM ig_evento WHERE publicado = '1' $filtro_fiscal $filtro_projeto AND dataEnvio IS NOT NULL";
	...
	<section id="list_items">
		<div class="container">
			...
			?>
					...
					<tbody>
				<?php
					$link="index.php?perfil=gestao_eventos&p=detalhe_reabertura&id_eve=";
					$data=date('Y');
					for($h = 0; $h < $x['num']; $h++)
					{		
