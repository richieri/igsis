...
?>
	...
	<section id="list_items" class="home-section bg-white">
		<div class="container">
			<h5>Dados do evento | 
				<a href="?perfil=gestao_eventos&p=detalhe_reabertura&pag=servicos&id_eve=<?php echo $idEvento;?>">Solicitação de serviços</a> | 
				<a href="?perfil=gestao_eventos&p=detalhe_reabertura&pag=pedidos&id_eve=<?php echo $idEvento;?>">Pedidos de contratação</a> |  
				<a href="?perfil=gestao_eventos&p=detalhe_reabertura&pag=pendencias&id_eve=<?php echo $idEvento;?>">Pendências</a>
			</h5>
...
?>	
	<section id="list_items" class="home-section bg-white">
		<div class="container">
			<h5><a href="?perfil=gestao_eventos&p=detalhe_reabertura&pag=inicial&id_eve=<?php echo $idEvento;?>">Dados do evento</a> | 
		...
		<div class="container">
			...
			<div class="form-group">
				<div class="col-md-offset-4 col-md-6">
					<form method='POST' action='?perfil=gestao_eventos&p=detalhe_reabertura&pag=finalizar&id_eve=<?php echo $idEvento;?>'>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-offset-2 col-md-8">
						<div class="text-hide">
							<h2>O evento será reaberto!</h2>
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-offset-2 col-md-8">
							<p>Uma vez reaberto o formulário, não poderá mais visualizá-lo até que o programador o envie.</p>
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-offset-2 col-md-8">
						...
						?>
							...
							<input type ='submit' class='btn btn-theme btn-lg btn-block' value='Enviar' onclick="this.disabled = true; this.value = 'Reabrindo…'; this.form.submit();">
							</form>
						</div>
					</div>
				</div>
