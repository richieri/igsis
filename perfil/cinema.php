<?php
	...
	{
		// Se for uma mostra de cinema, executa o módulo.
		...
		switch($p)
		{
			case "inicio":
				...
				include "../include/menuCinema.php";
?>
...
<section id="contact" class="home-section bg-white">
	...
	<?php 
			...
			case "editar":
				...
				{
					// Carrega dados sobre o filme a editar
					$filme = recuperaDados($_POST['idCinema']);
				}
				if(isset($_POST['inserirFilme']))
				{
					//Insere um filme
					$pais1 = $_POST['pais1'];
	  			...
	  			<div class="col-md-offset-1 col-md-10">
					<form class="form-horizontal" role="form" action="?perfil=cinema&p=editar" method="post">
						...
						<div class="form-group">
							<div class="col-md-offset-2 col-md-6"><strong>País de origem*:</strong><br/>
								<select class="form-control" id="pais1" name="pais1" >
									<?php geraOpcao("ig_pais",$filme['ig_pais_idPais'],""); ?>  
								</select>
							</div>				  
							<div class=" col-md-6"><strong>País de origem (co-produção):</strong><br/>
								<select class="form-control" id="pais2" name="pais2" >
									<option value="0">Não há</option>
									<?php geraOpcao("ig_pais",$filme['id_pais_idPais_2'],""); ?>  
								</select>
							</div>
						</div>
						<div class="form-group">
	...
	<div class="container">
		...
		<?php 
			...
			case "ocorrencias" :
				...
				{
					$sql_inserir = "INSERT INTO `ig_ocorrencia` 
						(`idOcorrencia`, 
						`idTipoOcorrencia`, 
						`ig_comunicao_idCom`, 
						`local`, 
				...
				if(isset($_POST['atualizar']))
				{
					...
					$sql_atualizar_ocorrencia = "UPDATE ig_ocorrencia 
						SET `idTipoOcorrencia` = '$tipoOcorrencia',
						`local` = '$local' ,
						`segunda` = '$segunda',
						`terca` = '$terca',
						`quarta` = '$quarta',
				...
				{
					$idOc = $_POST['duplicar'];
					$sql_duplicar_ocorrencia = "INSERT INTO ig_ocorrencia 
						(`idTipoOcorrencia`, 
						`ig_comunicao_idCom`, 
						`local`, 
						`idEvento`, 
            ...
            <div class="col-md-offset-1 col-md-10">
				...
				<?php
					...
					case "listar":
						...
						include "../include/menuCinemaOcorrencias.php";
				?>
<section id="list_items" class="home-section bg-white">
	<div class="container">
		<div class="row">
