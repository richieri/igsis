					...
					<div class="form-group">
						<div class="col-md-offset-2 col-md-8">
							<h5><?php if(isset($mensagem)){ echo $mensagem; } ?>
								<form method="POST" action="?perfil=emia&p=frm_concluir_emia" class="form-horizontal" role="form">
...
<?php
	...
	else
	{
		...
		{ //Não foi inserido o número do pedido
			...
			$sql_evento = "SELECT * FROM sis_emia,igsis_pedido_contratacao WHERE sis_emia.publicado = '1' AND igsis_pedido_contratacao.publicado = '1' AND sis_emia.idPedidoContratacao = igsis_pedido_contratacao.idPedidoContratacao $filtro_processo $filtro_status ORDER BY igsis_pedido_contratacao.idPedidoContratacao DESC";
...
?>
	...
	<section id="list_items">
		<div class="container">
			...
			<h5><a href="?perfil=emia&p=frm_concluir_emia">Fazer outra busca</a></h5>
