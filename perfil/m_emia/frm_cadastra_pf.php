...
<section id="list_items" class="home-section bg-white">
	...
	<div class="container">
		...
		<?php
			...
			{
				if(!isset($emia['IdPessoaFisica'])){ $for = "Não há"; }else{ $for = "Cadastrado"; }
				echo "<tr>";
...
<section id="services" class="home-section bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-offset-2 col-md-8">
				<div class="section-heading">
					<h3>Cadastro de Pessoa Física - EMIA</h3>					
				</div>
			</div>
		</div>
		<div class="row">
			<div class="form-group">
				<div class="col-md-offset-2 col-md-8">
					<form method="POST" action="?perfil=emia&p=frm_cadastra_pf" class="form-horizontal" role="form">
