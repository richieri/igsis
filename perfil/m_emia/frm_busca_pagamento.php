				...
				<div class="row">
					<div class="form-group">
						<div class="col-md-offset-2 col-md-8">
							...
							<form method="POST" action="?perfil=emia&p=frm_busca_pagamento" class="form-horizontal" role="form">
...
else
{
	...
	{ //Não foi inserido o número do pedido
		...
		$sql_evento = "SELECT igsis_pedido_contratacao.NumeroProcesso, igsis_pedido_contratacao.estado, sis_pessoa_fisica.Nome, igsis_pedido_contratacao.idPedidoContratacao FROM sis_emia,igsis_pedido_contratacao, sis_pessoa_fisica WHERE sis_emia.publicado = '1' AND igsis_pedido_contratacao.publicado = '1' AND sis_emia.idPedidoContratacao = igsis_pedido_contratacao.idPedidoContratacao AND igsis_pedido_contratacao.idPessoa = sis_pessoa_fisica.Id_PessoaFisica $filtro_processo $filtro_proponente $filtro_status ORDER BY sis_pessoa_fisica.Nome";
...
<section id="list_items">
	<div class="container">
		...
		<h5><a href="?perfil=emia&p=frm_busca_pagamento">Fazer outra busca</a></h5>
				...
				<table class="table table-condensed">
					...
					<?php
						...
						for($h = 0; $h < $x['num']; $h++)
						{
							...
							echo "<tr><td class='lista'> <a href='?perfil=emia&p=frm_cadastra_pagamento_pf&id_ped=".$x[$h]['id']."'>".$x[$h]['NumeroProcesso']."</a></td>";
