...
ALTER TABLE `ig_ocorrencia` ADD `subprefeitura_id` TINYINT(2) NULL AFTER `observacao`;
...
ALTER TABLE `ig_ocorrencia` ADD `idPeriodoDia` TINYINT(1) NULL AFTER `subprefeitura_id`;
