...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Encaminho o presente a Vossa Senhoria para a reserva de recursos no valor de R$ ".$ValorGlobal."  (".$ValorPorExtenso." ) que deverá onerar a RESERVA PARA PESSOA JURÍDICA nº ".$NumeroReservaPJ.", SEI ".$LinkPJ." da dotação ".$dotacao.".</p>".
  "<p>&nbsp;</p>".
