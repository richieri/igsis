...
$LinkPF = $verba["linkpj"];
$NumeroReservaPF = $verba["reservapj"];
...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Encaminho o presente a Vossa Senhoria para a reserva de recursos no valor de R$ ".$ValorGlobal."  (".$ValorPorExtenso." ) que deverá onerar a RESERVA PARA PESSOA FÍSICA nº ".$NumeroReservaPF.", SEI ".$LinkPF." da dotação ".$dotacao.".</p>".
  "<p>&nbsp;</p>".
