...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Autorizo a reserva de recursos no valor de R$ ".$ValorGlobal."  (".$ValorPorExtenso." ) na Atividade 6354 – Programação de Atividades Culturais da U.O. 25.60 (Pessoa Física) visando possibilitar a contratação acima mencionada.</p>".
