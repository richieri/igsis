...
$sei = 
  ...
  "<p><b>Valor:</b> R$ $ValorGlobal ($ValorPorExtenso )</p>".
    "<p>&nbsp;</p>".
  "<p>Diante do exposto, autorizo a reserva de recursos proveniente da nota de reserva inclusa no processo $processoMae - (Pessoa Física) para a presente contratação.</p>".
  "<p>&nbsp;</p>".
