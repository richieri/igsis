...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Encaminho o presente a Vossa Senhoria para a necessária reserva de recursos no valor mencionado, onerando a reserva com  transferência nº 22983, documento SEI .</p>".
  "<p>&nbsp;</p>".
