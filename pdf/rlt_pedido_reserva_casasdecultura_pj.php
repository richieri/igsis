...
$sei = 
 ...
 "<p>&nbsp;</p>".
  ...
  "<p>&nbsp;</p>".
  "<p>Autorizo a reserva de recursos no valor de R$ ".$ValorGlobal."  (".$ValorPorExtenso." ) na Atividade 6354 – Programação de Atividades Culturais da U.O. 25.70 (Pessoa Jurídica) visando possibilitar a contratação acima mencionada.</p>".
  "<p>Supervisão das Casas de Cultura</p>".
  "<p>&nbsp;</p>".
