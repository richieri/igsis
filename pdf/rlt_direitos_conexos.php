...
$l=6; //DEFINE A ALTURA DA LINHA   
   ...
   $pdf->Cell(180,5,utf8_decode("AUTORIZAÇÃO DE USO DE DIREITOS CONEXOS"),0,1,'C');
   ...
   $pdf->MultiCell(170,$l,utf8_decode("Nós, abaixo assinadas, AUTORIZAMOS, gratuitamente, a PREFEITURA DO MUNICÍPIO DE SÃO PAULO, por meio da Secretaria Municipal de Cultura/".$setor.", a utilizar os direitos conexos relativos às gravações de áudio e vídeo da nossa participação, captado no concerto a ser realizado em ".$Periodo." no(s) local(is) ".$Local.", para fins de inserção no site, exclusivamente para fins não comerciais, pelo prazo de proteção do artigo 96 da Lei 9.610/98."));
