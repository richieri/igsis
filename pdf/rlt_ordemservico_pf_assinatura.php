...
$l=6; //DEFINE A ALTURA DA LINHA   
   ...
   $pdf->SetFont('Arial','', 10);
   $pdf->Cell(65,$l,utf8_decode($CPF),0,0,'L');
   $pdf->SetFont('Arial','B', 10);
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','B', 10);
   $pdf->Cell(22,$l,utf8_decode('Estado Civil:'),0,0,'L');
   $pdf->SetFont('Arial','', 10);
