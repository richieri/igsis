...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Autorizo a reserva de recursos no valor de R$ "."$ValorGlobal"."("."$ValorPorExtenso".") na Dotação 6354 da U.O 25.10 (Pessoa Física) visando possibilitar a contratação de "."$objeto"." para participação na Virada Cultural 2017.</p>".
  "<p>&nbsp;</p>".
