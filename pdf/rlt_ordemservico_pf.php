...
$l=6; //DEFINE A ALTURA DA LINHA   
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','B', 10);
   $pdf->Cell(28,$l,utf8_decode('Representante:'),0,0,'L');
   $pdf->SetFont('Arial','', 10);
   ...
   $pdf->SetFont('Arial','', 10);
   $pdf->Cell(48,$l,utf8_decode($Nacionalidade),0,1,'L');
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','', 10);
   $pdf->MultiCell(180,$l,utf8_decode('O pagamento corresponderá à reversão integral da renda obtida na bilheteria a/o contratada/o, deduzidos os impostos e taxas pertinentes.'));
...
- As providências administrativas para liberação da autorização do ECAD serão de responsabilidade da/o contratada/o, assim como eventuais pagamentos.
...
Aceito as condições dessa O.E.S para todos os efeitos de direito."));
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','B', 10);
   $pdf->Cell(120,$l,utf8_decode('Diretor do Centro Cultural da Cidade de São Paulo'),'',1,'L');
