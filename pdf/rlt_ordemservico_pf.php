...
$l=6; //DEFINE A ALTURA DA LINHA   
   ...
   $pdf->SetFont('Arial','', 10);
   $pdf->Cell(65,$l,utf8_decode($RG),0,0,'L');
   $pdf->SetFont('Arial','B', 10);
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','', 10);
   $pdf->MultiCell(180,$l,utf8_decode("Especificações: Contratação dos serviços profissionais de natureza artística de: ".$integrantes." para apresentação de "."$Objeto".", no(s) local(is)"."$Local"." no perído de "."$Periodo"." conforme cronograma."));		
