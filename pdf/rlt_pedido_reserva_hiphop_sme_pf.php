...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Diante do exposto, autorizo a realização da reserva de recursos proveniente da nota de reserva (link da Nota de transferência) - (Pessoa Física) para a presente contratação.</p>".
  "<p>&nbsp;</p>".
