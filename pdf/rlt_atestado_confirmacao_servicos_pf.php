...
$perioado = explode(" a ",$pedido['Periodo']);
...
equivalente) no dia {$perioado[1]}, dentro do prazo previsto.<br>O prazo contratual é do dia {$perioado[0]} até o dia {$perioado[1]}.</p>".
