...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Encaminho o presente a Vossa Senhoria para a reserva de recursos no valor de R$ ".$ValorGlobal."  (".$ValorPorExtenso." ) que deverá onerar a dotação ".$dotacao." PESSOA FÍSICA.</p>".
  "<p>&nbsp;</p>".
