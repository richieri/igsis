...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Encaminho o presente a Vossa Senhoria para a reserva de recursos no valor de R$ ".$ValorGlobal."  (".$ValorPorExtenso.") que deverá onerar a RESERVA ---------- PARA PESSOA FÍSICA, nº ------------, SEI --------------.</p>".
  "<p>&nbsp;</p>".
  "<p>Após, enviar a Assessoria Jurídica para prosseguimento.</p>".
  "<p>&nbsp;</p>"
