	...
	*/
	...
	function enviarEmail($conteudo_email, $instituicao, $subject, $email, $usuario )
	{
		...
		try
		{
			...
			$mail->Username   = "sistema.igsis@gmail.com";	// GMAIL username
			...
			$sql_user = "SELECT DISTINCT ig_usuario.nomeCompleto, 
				...
				OR ig_papelusuario.contratos = '1' 
	...
	*/
	...
	function listaFilmes($idEvento)
	{
		...
		while($campo = mysqli_fetch_array($query))
		{
			...
			$campo['titulo']
				...
				.$campo['anoProducao']." - ".$campo['minutagem']."min. - ".$campo['bitola']." ) 
				<br />Direção: ".$campo['direcao']."<br />";	
			echo "<tr>";
	...
	function listaServicosInternos($idEvento)
	{
		...
		if($interno)
		{
			...
			{
				echo "Carros: ".$interno['carros']."<br />";
			}	
			if(($interno['equipe'] != '') AND ($interno['equipe'] != NULL))
			{
				echo "Equipe: ".$interno['equipe']."<br />";
			}	
			if(($interno['infraestrutura'] != '') AND ($interno['infraestrutura'] != NULL))
			{
				echo "Infraestrutura: ".$interno['infraestrutura']."<br />";
			}	
